...
export class FollowUserProfile extends Component {
    ...
    getFollowerDetail = async () => {
        console.log("id", this.state.item.user.id);
        this.setState({ loader: true })
        try {
            const response = await axios.get(`${baseUrl}/user/${this.state.item.user.id}`, {
