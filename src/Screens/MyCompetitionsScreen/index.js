import { View, Text, SafeAreaView, FlatList, Image, Alert, Pressable, ScrollView, ImageBackground, StyleSheet, TextInput, Dimensions } from 'react-native'
...
class MyCompetitionsScreen extends Component {
    ...
    getLoginUserData = async () => {
        await AsyncStorage.getItem('userData').then((cart) => {
            if (cart !== null) {
                ...
                this.setState({ competition_length: this.state.userData.competition.length })
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ backgroundColor: '#2A7862', paddingBottom: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 20, alignSelf: 'flex-start', marginLeft: 16 }}>My Competitions</Text>
                        ...
                        this.state.competition_length > 0 ?
                            // <Text style={{ fontSize: 18, color: '#546881', fontWeight: '500' }}>No competitions posted yet</Text> :
                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item }) => <MyCompetitionsView item={item} navigation={this.props.navigation} />}
