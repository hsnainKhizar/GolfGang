...
export class MyCompetitionsView extends Component {
    ...
    checkCompetitionDetail = () => {
        ...
        this.props.navigation.navigate('MyDetail',item)
    }
    ...
    updateViewsDetail = async () => {
        ...
        let competition_id = this.state.userData.id
        let user_id = this.state.item.id
...
export default MyCompetitionsView